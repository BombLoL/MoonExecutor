...
TopBar.Position = UDim2.new(0.49951601, 0, 0.21825397, 0)
...
Title.Position = UDim2.new(0.499068081, 0, 0.528571427, 0)
Title.Size = UDim2.new(0, 179, 0, 28)
...
Minimize.BackgroundColor3 = Color3.fromRGB(28, 68, 213)
Minimize.BorderColor3 = Color3.fromRGB(0, 0, 0)
Minimize.BorderSizePixel = 0
Minimize.Position = UDim2.new(0.841836751, 0, 0.142857149, 0)
...
Close.Name = "Close"
Close.Parent = TopBar
Close.BackgroundColor3 = Color3.fromRGB(28, 68, 213)
Close.BorderColor3 = Color3.fromRGB(0, 0, 0)
Close.BorderSizePixel = 0
Close.Position = UDim2.new(0.918367326, 0, 0.142857149, 0)
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(115, 115, 115)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(38, 38, 38))}
...
Main.Position = UDim2.new(0.5, 0, 4.5250001, 0)
Main.Size = UDim2.new(0, 588, 0, 251)

Main2.Name = "Main2"
Main2.Parent = Main
Main2.AnchorPoint = Vector2.new(0.5, 0.5)
Main2.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
Main2.BackgroundTransparency = 0.100
Main2.BorderColor3 = Color3.fromRGB(0, 0, 0)
Main2.BorderSizePixel = 0
Main2.Position = UDim2.new(0.497741401, 0, 0.496196121, 0)
Main2.Size = UDim2.new(0, 576, 0, 235)

Script.Name = "Script"
Script.Parent = Main2
Script.AnchorPoint = Vector2.new(0.5, 0.5)
Script.BackgroundColor3 = Color3.fromRGB(11, 28, 86)
...
Tabs.Position = UDim2.new(0.508001626, 0, 0.0646258444, 0)
Tabs.Size = UDim2.new(0, 562, 0, 22)
...
B.BackgroundColor3 = Color3.fromRGB(28, 68, 213)
B.BorderColor3 = Color3.fromRGB(0, 0, 0)
B.BorderSizePixel = 0
B.Position = UDim2.new(0.295918375, 0, 0.057823129, 0)
B.Size = UDim2.new(0, 96, 0, 19)
...
A.BackgroundColor3 = Color3.fromRGB(28, 68, 213)
A.BorderColor3 = Color3.fromRGB(0, 0, 0)
A.BorderSizePixel = 0
A.Position = UDim2.new(0.10204082, 0, 0.0595238097, 0)
A.Size = UDim2.new(0, 96, 0, 19)
...
C.BackgroundColor3 = Color3.fromRGB(28, 68, 213)
C.BorderColor3 = Color3.fromRGB(0, 0, 0)
C.BorderSizePixel = 0
C.Position = UDim2.new(0.295918375, 0, 0.057823129, 0)
C.Size = UDim2.new(0, 96, 0, 19)
...
CustomNotification.AnchorPoint = Vector2.new(0.5, 0.5)
CustomNotification.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
CustomNotification.BackgroundTransparency = 0.100
CustomNotification.BorderColor3 = Color3.fromRGB(0, 0, 0)
CustomNotification.BorderSizePixel = 0
CustomNotification.Position = UDim2.new(0.894494832, 0, 0.795634925, 0)
...
Message.Position = UDim2.new(0.496149898, 0, 0.600543499, 0)
Message.Size = UDim2.new(0, 157, 0, 129)
Message.Font = Enum.Font.Arial
Message.Text = "This is a test message, so just ignore it."
Message.TextColor3 = Color3.fromRGB(255, 255, 255)
Message.TextScaled = true
Message.TextSize = 14.000
Message.TextWrapped = true

UIGradient_4.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(115, 115, 115)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(38, 38, 38))}
UIGradient_4.Rotation = 90
UIGradient_4.Parent = CustomNotification

Seperator.Name = "Seperator"
Seperator.Parent = CustomNotification
Seperator.AnchorPoint = Vector2.new(0.5, 0.5)
Seperator.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Seperator.BorderColor3 = Color3.fromRGB(0, 0, 0)
Seperator.BorderSizePixel = 0
Seperator.Position = UDim2.new(0.5, 0, 0.220108703, 0)
Seperator.Size = UDim2.new(0, 200, 0, -1)

Start.Name = "Start"
Start.Parent = MoonExec
Start.AnchorPoint = Vector2.new(0.5, 0.5)
Start.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
Start.BackgroundTransparency = 0.100
Start.BorderColor3 = Color3.fromRGB(0, 0, 0)
Start.BorderSizePixel = 0
Start.Position = UDim2.new(0.5, 0, 0.499634922, 0)
Start.Size = UDim2.new(0, 588, 0, 294)

Main2_2.Name = "Main2"
Main2_2.Parent = Start
Main2_2.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
Main2_2.BackgroundTransparency = 0.400
Main2_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
Main2_2.BorderSizePixel = 0
...
Changelogs.Position = UDim2.new(0.713, 0, 0.550000012, 0)
Changelogs.Size = UDim2.new(0, 243, 0, 149)
Changelogs.ZIndex = 999999999

Scroll.Name = "Scroll"
Scroll.Parent = Changelogs
Scroll.Active = true
...
Scroll.Position = UDim2.new(0.49930048, 0, 0.504769266, 0)
Scroll.Size = UDim2.new(0, 243, 0, 149)
Scroll.BottomImage = "rbxassetid://0"
Scroll.CanvasSize = UDim2.new(0, 0, 4, 0)
Scroll.MidImage = "rbxassetid://0"
Scroll.TopImage = "rbxassetid://0"

Changelog0.Name = "Changelog0"
Changelog0.Parent = Scroll
Changelog0.AnchorPoint = Vector2.new(0.5, 0.5)
Changelog0.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Changelog0.BackgroundTransparency = 1.000
Changelog0.BorderColor3 = Color3.fromRGB(0, 0, 0)
Changelog0.BorderSizePixel = 0
Changelog0.Position = UDim2.new(0.499918401, 0, 0.238095239, 0)
Changelog0.Size = UDim2.new(0, 232, 0, 22)
Changelog0.Font = Enum.Font.Arial
Changelog0.Text = "CHANGELOGS"
Changelog0.TextColor3 = Color3.fromRGB(255, 255, 255)
Changelog0.TextScaled = true
Changelog0.TextSize = 14.000
Changelog0.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
Changelog0.TextWrapped = true

UIListLayout.Parent = Scroll

Changelog1.Name = "Changelog1"
Changelog1.Parent = Scroll
Changelog1.AnchorPoint = Vector2.new(0.5, 0.5)
Changelog1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Changelog1.BackgroundTransparency = 1.000
Changelog1.BorderColor3 = Color3.fromRGB(0, 0, 0)
Changelog1.BorderSizePixel = 0
Changelog1.Position = UDim2.new(0.499918401, 0, 0.301020414, 0)
Changelog1.Size = UDim2.new(0, 232, 0, 15)
Changelog1.Font = Enum.Font.Arial
Changelog1.Text = "[+] Remade UI"
Changelog1.TextColor3 = Color3.fromRGB(255, 255, 255)
Changelog1.TextScaled = true
Changelog1.TextSize = 14.000
Changelog1.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
Changelog1.TextWrapped = true

Changelog2.Name = "Changelog2"
Changelog2.Parent = Scroll
Changelog2.AnchorPoint = Vector2.new(0.5, 0.5)
Changelog2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Changelog2.BackgroundTransparency = 1.000
Changelog2.BorderColor3 = Color3.fromRGB(0, 0, 0)
Changelog2.BorderSizePixel = 0
...
Changelog2.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
Changelog2.TextWrapped = true

Changelog3.Name = "Changelog3"
Changelog3.Parent = Scroll
Changelog3.AnchorPoint = Vector2.new(0.5, 0.5)
Changelog3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Changelog3.BackgroundTransparency = 1.000
Changelog3.BorderColor3 = Color3.fromRGB(0, 0, 0)
Changelog3.BorderSizePixel = 0
...
Changelog3.TextStrokeColor3 = Color3.fromRGB(255, 255, 255)
Changelog3.TextWrapped = true

Changelog4.Name = "Changelog4"
Changelog4.Parent = Scroll
Changelog4.AnchorPoint = Vector2.new(0.5, 0.5)
Changelog4.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Changelog4.BackgroundTransparency = 1.000
Changelog4.BorderColor3 = Color3.fromRGB(0, 0, 0)
Changelog4.BorderSizePixel = 0
...
Open.BackgroundColor3 = Color3.fromRGB(28, 68, 213)
Open.BorderColor3 = Color3.fromRGB(0, 0, 0)
Open.BorderSizePixel = 0
Open.Position = UDim2.new(0.244642854, 0, 0.864960253, 0)
Open.Size = UDim2.new(0, 204, 0, 50)
Open.ZIndex = 999999999
Open.Font = Enum.Font.Arial
Open.Text = "Launch Moon"
...
Desc.Position = UDim2.new(0.713353813, 0, 0.219387755, 0)
Desc.Size = UDim2.new(0, 160, 0, 29)
...
UIGradient_5.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30, 30, 30)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 20, 20))}
UIGradient_5.Rotation = 90
UIGradient_5.Parent = Main2_2

Disclaimer.Name = "Disclaimer"
Disclaimer.Parent = Main2_2
Disclaimer.BackgroundColor3 = Color3.fromRGB(28, 68, 213)
Disclaimer.BorderColor3 = Color3.fromRGB(0, 0, 0)
Disclaimer.BorderSizePixel = 0
Disclaimer.Position = UDim2.new(0.0660714284, 0, 0.244493276, 0)
Disclaimer.Size = UDim2.new(0, 200, 0, 116)
Disclaimer.Font = Enum.Font.SourceSans
Disclaimer.Text = "This is still on testing, so theres might be some issues with the executor."
...
DisclaimerImage.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
DisclaimerImage.BackgroundTransparency = 1.000
DisclaimerImage.BorderColor3 = Color3.fromRGB(0, 0, 0)
DisclaimerImage.BorderSizePixel = 0
DisclaimerImage.Position = UDim2.new(0.200000003, 0, 0.04460961, 0)
DisclaimerImage.Size = UDim2.new(0, 49, 0, 42)
...
local function UCBE_fake_script() -- MoonExec.UnBDRjM5VlVnNmhmSlNW 
	...
	local function MthU3Qb5cZXYUi2(m,n)
		local length = math.random(m,n)
		local array = {}
		for i = 1, length do
			array[i] = string.char(math.random(1, 226))
		end
		return table.concat(array)
	end
